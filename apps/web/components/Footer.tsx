                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <div className="flex gap-4">
                            <a href="#" aria-label="Twitter Profile" className="w-10 h-10 rounded-full border border-gray-200 dark:border-white/10 flex items-center justify-center text-navy dark:text-offwhite hover:bg-navy hover:text-white dark:hover:bg-offwhite dark:hover:text-deep-navy transition-all">
                            ...
                            <a href="#" aria-label="Instagram Profile" className="w-10 h-10 rounded-full border border-gray-200 dark:border-white/10 flex items-center justify-center text-navy dark:text-offwhite hover:bg-navy hover:text-white dark:hover:bg-offwhite dark:hover:text-deep-navy transition-all">
